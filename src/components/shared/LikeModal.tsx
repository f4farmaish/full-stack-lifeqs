...
const LikeModal = ({ isOpen, onClose, likedUsers, postId }: LikeModalProps) => {
    ...
    <div
      ...
      <div
        ...
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold text-light-1">{t("likeModal.likedBy")}</h2>
          <button
            onClick={onClose}
        ...
        <input
          type="text"
          placeholder={t("likeModal.searchUsers")}
        ...
        <div className="max-h-[450px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-300">
          {filteredUsers.length === 0 ? (
            <p className="text-light-3 text-center">{t("likeModal.noUsersFound")}</p>
          ) : (
